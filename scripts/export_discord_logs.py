...
CHANNELS = [
    {"label": "インプット", "env_id": "DISCORD_CHANNEL_ID_INPUT", "log_dir": "logs/daily"},
    {"label": "ヘルス・日報", "env_id": "DISCORD_CHANNEL_ID_HEALTH", "log_dir": "logs/health"},
]
...
def main():
    ...
    for channel in CHANNELS:
        ...
        print(f"=== #{channel['label']} のメッセージを取得します ===")
        try:
