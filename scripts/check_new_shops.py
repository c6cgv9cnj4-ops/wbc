# -*- coding: utf-8 -*-
"""
「行きつけ名店発掘（北本13km）」新着・昇格店舗 検知バッチ

photo/index.html の「行きつけ名店発掘」タブは北本団地(36.0260, 139.5180)から
直線距離13km圏内の個人経営の飲食店・喫茶店を紹介するが、その候補は手動で
...
KNOWN_SHOP_NAMES = [
    ...
    "手打うどん 松屋", "深山うどん", "うどん 有田", "藤倉食堂",
]
# 「水織」は2024-09-01付で休業確認のため除外済み(細川さんの指摘、2026-09-13)。
# 「いづみや」「長林」「そば処甚五郎(北本市中丸)」は複数回ウェブ検索したが実在を
# 確認できなかった名称のため、KNOWN扱いにも新規登録にも含めていない。
...
def search_places(api_key, query):
    body = {
        "textQuery": f"{query} 埼玉県 北本 鴻巣 桶川 上尾 川島 吉見",
        "languageCode": "ja",
        "maxResultCount": 20,
        "locationBias": {
            "circle": {
